Feature: As a user, I should be able to access detailed information about the user who logged into the system
  via API connection.
  ...
  the expected status code returned should be 200, and the message in the response body should confirm: "success".
    ...
    * The api users constructs the base url with the "customer" token.
    * The api users sets "api/customerGetUser" path parameters
